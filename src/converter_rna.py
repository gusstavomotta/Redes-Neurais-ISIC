...
OUTPUT_DIR = "modelo_convertido" 
PTL_MODEL_PATH = os.path.join(OUTPUT_DIR, "model.ptl")
...
def run_export():
    ...
    try:
        ...
        print(f"\nModelo PyTorch Mobile (.ptl) salvo em: {PTL_MODEL_PATH}")

    except Exception as e:
        print(f"Erro na exportação para TorchScript: {e}")
        return
